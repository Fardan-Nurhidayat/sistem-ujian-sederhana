                ...
                <form method="POST" action="{{ route('ujian.store') }}" class="space-y-6">
                    ...
                    <div>
                        ...
                        <select id="mata_pelajaran_id" name="mata_pelajaran_id" class="mt-1 block w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm" required>
                            ...
                            <option value="{{ $mataPelajaran->id }}" @selected(old('mata_pelajaran_id')==$mataPelajaran->id)>
                    ...
                    <div>
                        ...
                        <x-input id="tanggal" name="tanggal" type="date" class="mt-1 block w-full" value="{{ old('tanggal') }}" required />
